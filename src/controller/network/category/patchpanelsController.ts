...
export const exportPatchpanelsCsv = async (req: Request, res: Response) => {
...
export const exportPatchpanelsXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const createPatchpanels = async (req: Request, res: Response) => {
  const deviceColumns = [
    'brand_id',
    'vendor_id',
    'user_id',
...
export const updatePatchpanels = async (req: Request, res: Response) => {
  const deviceColumns = [
    'brand_id',
    'vendor_id',
    'user_id',
...
export const deletePatchpanels = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    req,
    res,
    pool,
    `DELETE FROM network WHERE device_id = ?`,
    `DELETE FROM network_patch_panels WHERE id = ?`,
