...
export const brandStorage = async (req: Request, res: Response) => {
  await getOneRow(req, res, pool, `SELECT * FROM storage_brand WHERE id = ?`);
};

export const createBrandStorage = async (req: Request, res: Response) => {
  const columns = ['name'];
  await createEntity(req, res, 'storage_brand', 'NISRB', columns);
};

export const updateBrandStorage = async (req: Request, res: Response) => {
  const columns = ['name'];
  await updateEntity(req, res, 'storage_brand', columns);
};

export const deleteBrandStorage = async (req: Request, res: Response) => {
  await deleteRow(req, res, pool, `DELETE FROM storage_brand WHERE id = ?`);
};
