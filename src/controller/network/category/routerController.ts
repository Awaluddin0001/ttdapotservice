...
export const exportRouterCsv = async (req: Request, res: Response) => {
...
export const exportRouterXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const deleteRouter = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM network_routers WHERE id = ?`,
