...
export const exportUpsCsv = async (req: Request, res: Response) => {
...
export const exportUpsXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const updateUps = async (req: Request, res: Response) => {
  ...
  await updateRow(req, res, 'electrical_ups', deviceColumns, electricalColumns);
};
...
export const deleteUps = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM electrical_ups WHERE id = ?`,
