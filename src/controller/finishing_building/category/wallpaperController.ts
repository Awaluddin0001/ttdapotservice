...
export const exportWallpaperCsv = async (req: Request, res: Response) => {
...
export const exportWallpaperXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const Wallpaper = async (req: Request, res: Response) => {
  await getBigDeviceRow(
    ...
    `SELECT 
        ...
        ty.id as type_id
      FROM building_finishes_wallpaper r
...
export const deleteWallpaper = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM building_finishes_wallpaper WHERE id = ?`,
