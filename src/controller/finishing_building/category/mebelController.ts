...
export const exportMebelCsv = async (req: Request, res: Response) => {
...
export const exportMebelXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const Mebel = async (req: Request, res: Response) => {
  await getBigDeviceRow(
    ...
    `SELECT 
        ...
        ty.id as type_id
      FROM building_finishes_mebel r
...
export const deleteMebel = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM building_finishes_mebel WHERE id = ?`,
