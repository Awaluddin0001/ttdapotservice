...
export const exportDoorCsv = async (req: Request, res: Response) => {
...
export const exportDoorXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const deleteDoor = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM building_finishes_door WHERE id = ?`,
