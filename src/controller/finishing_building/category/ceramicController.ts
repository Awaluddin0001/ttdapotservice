...
export const allCeramic = async (req: Request, res: Response) => {
...
export const exportCeramicCsv = async (req: Request, res: Response) => {
...
export const exportCeramicXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const Ceramic = async (req: Request, res: Response) => {
  await getBigDeviceRow(
    ...
    `SELECT 
        ...
        ty.id as type_id
      FROM building_finishes_ceramic r
...
export const createCeramic = async (req: Request, res: Response) => {
  const deviceColumns = [
    'brand_id',
    'vendor_id',
    'user_id',
...
export const updateCeramic = async (req: Request, res: Response) => {
  const deviceColumns = [
    'brand_id',
    'vendor_id',
    'user_id',
...
export const deleteCeramic = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    req,
    res,
    pool,
    `DELETE FROM building_finishes WHERE device_id = ?`,
    `DELETE FROM building_finishes_ceramic WHERE id = ?`,
