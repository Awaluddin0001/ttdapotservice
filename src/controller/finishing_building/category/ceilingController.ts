...
export const exportCeilingCsv = async (req: Request, res: Response) => {
...
export const exportCeilingXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const Ceiling = async (req: Request, res: Response) => {
  await getBigDeviceRow(
    ...
    `SELECT 
        ...
        ty.id as type_id
      FROM building_finishes_ceiling r
...
export const deleteCeiling = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM building_finishes_ceiling WHERE id = ?`,
