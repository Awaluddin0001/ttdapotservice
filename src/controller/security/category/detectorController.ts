...
export const allDetector = async (req: Request, res: Response) => {
...
export const exportDetectorCsv = async (req: Request, res: Response) => {
...
export const exportDetectorXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const Detector = async (req: Request, res: Response) => {
...
export const createDetector = async (req: Request, res: Response) => {
...
export const updateDetector = async (req: Request, res: Response) => {
  const deviceColumns = ['brand_id', 'vendor_id', 'user_id', 'type_id'];
  const securityColumns = [
    'site_id',
    'floor_id',
...
export const deleteDetector = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    req,
    res,
    pool,
    `DELETE FROM security WHERE device_id = ?`,
    `DELETE FROM security_detector WHERE id = ?`,
