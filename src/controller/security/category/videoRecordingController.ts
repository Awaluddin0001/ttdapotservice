...
export const exportVideoRecordingCsv = async (req: Request, res: Response) => {
...
export const exportVideoRecordingXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const VideoRecording = async (req: Request, res: Response) => {
  await getBigDeviceRow(
    ...
    `SELECT 
        ...
        ty.id as type_id
      FROM security_video_recording r
...
export const createVideoRecording = async (req: Request, res: Response) => {
  const deviceColumns = ['brand_id', 'vendor_id', 'user_id', 'type_id', 'ip'];
...
export const deleteVideoRecording = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM security_video_recording WHERE id = ?`,
