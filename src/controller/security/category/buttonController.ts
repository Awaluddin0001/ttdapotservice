...
export const exportButtonCsv = async (req: Request, res: Response) => {
...
export const exportButtonXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const deleteButton = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM security_button WHERE id = ?`,
