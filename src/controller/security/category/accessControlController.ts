...
export const exportAccessControlCsv = async (req: Request, res: Response) => {
...
export const exportAccessControlXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const AccessControl = async (req: Request, res: Response) => {
  await getBigDeviceRow(
    ...
    `SELECT 
        ...
        ty.id as type_id
      FROM security_access_control r
...
export const deleteAccessControl = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM security_access_control WHERE id = ?`,
