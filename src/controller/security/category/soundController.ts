...
export const allBrandSound = async (req: Request, res: Response) => {
  await getAllRow(req, res, pool, `SELECT * FROM sound_brand`, `sound_brand`);
};

export const brandSound = async (req: Request, res: Response) => {
  await getOneRow(req, res, pool, `SELECT * FROM sound_brand WHERE id = ?`);
};
...
export const deleteBrandSound = async (req: Request, res: Response) => {
  await deleteRow(req, res, pool, `DELETE FROM sound_brand WHERE id = ?`);
};
