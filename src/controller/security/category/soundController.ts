...
export const exportSoundCsv = async (req: Request, res: Response) => {
...
export const exportSoundXlsx = async (req: Request, res: Response) => {
  await exportBigDeviceRows(
    req,
    res,
    pool,
...
export const deleteSound = async (req: Request, res: Response) => {
  await deleteCombinedRow(
    ...
    `DELETE FROM security_sound WHERE id = ?`,
