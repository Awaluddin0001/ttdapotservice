...
export const allAccessControl = async (req: Request, res: Response) => {
  await getAllRow(
    ...
    FROM access_control r
    LEFT JOIN access_control_brand b ON r.brand_id = b.id
...
export const createAccessControl = async (req: Request, res: Response) => {
...
export const allBrandAccessControl = async (req: Request, res: Response) => {
  await getAllRow(req, res, connectMySQL, `SELECT * FROM access_control_brand`);
};

export const brandAccessControl = async (req: Request, res: Response) => {
  await getOneRow(
    req,
    res,
    connectMySQL,
    `SELECT * FROM access_control_brand WHERE id = ?`,
  );
};

export const createBrandAccessControl = async (req: Request, res: Response) => {
  const columns = ['name'];
  await createEntity(req, res, 'access_control_brand', 'SEACB', columns);
};

export const updateBrandAccessControl = async (req: Request, res: Response) => {
  const columns = ['name'];
  await updateEntity(req, res, 'access_control_brand', columns);
};

export const deleteBrandAccessControl = async (req: Request, res: Response) => {
  await deleteRow(
    req,
    res,
    connectMySQL,
    `DELETE FROM access_control_brand WHERE id = ?`,
  );
};
